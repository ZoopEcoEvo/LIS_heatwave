...
#usage `r colorize("Here's a test comment", "red")`
```
...
knitr::kable(exp_design, align = "c", 
             caption = "Caption")
```
...
```{r, figure2, echo = F, out.width = "400px", fig.cap = "caption"}
...
```{r, figure3, echo = F, out.width = "400px", fig.cap = "caption"}
...
```{r, figure4, echo = F, out.width = "400px", fig.cap = "caption"}
...
```{r, supp1, echo = F, out.width = "350px"}
knitr::include_graphics("../Output/Figures/markdown/Supp-Fig-1-F0-treatement-effects-est-plots-1.png")
```

\newpage

## Supp. Fig. 2 {.unnumbered}

Effects of parental exposure to heatwaves on F1 body size at different developmental temperatures.

```{r, supp2, echo = F, out.width = "350px"}
knitr::include_graphics("../Output/Figures/markdown/F1-body-size-eff-plots-1.png")
```

\newpage

## Supp. Fig. 3 {.unnumbered}

Effects of parental exposure to heatwaves on F1 egg production at different developmental temperatures.

```{r, supp3, echo = F, out.width = "350px"}
knitr::include_graphics("../Output/Figures/markdown/F1-total-epr-eff-plots-1.png")
```

\newpage

## Supp. Fig. 4 {.unnumbered}

Effects of parental exposure to heatwaves on F1 hatching success at different developmental temperatures.

```{r, supp4, echo = F, out.width = "350px"}
knitr::include_graphics("../Output/Figures/markdown/F1-hatching-success-eff-plots-1.png")
```

\newpage

## Supp. Fig. 5 {.unnumbered}

Effects of parental exposure to heatwaves on F1 production at different developmental temperatures.

```{r, supp5, echo = F, out.width = "350px"}
