...
$if(title)$
\title{$title$$if(subtitle)$: $subtitle$$endif$ $if(anonymous)$ $endif$ }
$endif$ 
...
$if(anonymous)$\hfill $else$$for(author)$\textbf{\authorfont $author.name$} \hskip 5pt \emph{\small $author.affiliation$}  $sep$ \par $endfor$ $endif$
