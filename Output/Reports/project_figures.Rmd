...
F1_summary = bind_rows(F1_rf_effect_size, F1_bs_effect_size) %>% 
  ...
  mutate(trait = str_replace_all(trait, "size", "body size"),
         "order_code" = paste(trait, duration, sep = "_"),
...
```{r F0-production, fig.height=11, fig.width=8}
F0_fecundity_plot
```
